...
function (_React$Component) {
  ...
  _createClass(Login, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement(layout["a" /* default */], null, react_default.a.createElement(Content, {
        style: {
          margin: 16,
          overflow: 'initial'
        }
      ...
      }, react_default.a.createElement(es_form["a" /* default */].Item, null, getFieldDecorator('username', {
        rules: [{
          required: true,
          message: 'Please input Username!'
        }]
      })(react_default.a.createElement(input["a" /* default */], {
        prefix: react_default.a.createElement(icon["a" /* default */], {
          type: "user",
          style: {
            color: 'rgba(0,0,0,.25)'
          }
    ...
    value: function handleSubmit(event) {
      ...
      this.props.form.validateFields(function (err, values) {
        if (err) {
          ...
          console.log(values);
          axios_default.a.post('/login', values).then(function (response) {
            console.log('res', response);
            window.location.href = '/admin/';
          })["catch"](function (error) {
            Object(Notification["a" /* Notification */])('Wrong login or password', 'error');
          });
        }
      });
    }
...
var WrappedLoginForm = es_form["a" /* default */].create({
  name: 'login_form'
})(Login_Login);
/* harmony default export */ var admin_Login = (WrappedLoginForm);
// CONCATENATED MODULE: ./resources/admin/login.js



react_dom_default.a.render(react_default.a.createElement(admin_Login, null), document.getElementById("root"));
